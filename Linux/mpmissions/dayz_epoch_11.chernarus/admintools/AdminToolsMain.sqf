...
_pathtodean = "admintools\deanscustom\";
...
_EXECscript6 = 'player execVM "'+_pathtodean+'%1"';
	...
	if ((getPlayerUID player) in ["#######","#######"]) then { // super admins
		...
		[
			["",true],
				...
				["Dean's Custom Addons", [7], "#USER:DeanMenu", -5, [["expression", ""]], "1", "1"],
				["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]		
		];};
};
...
[
	["",true],
		["Money Box", [2],  "", -5, [["expression", format[_EXECscript6,"MoneyBox.sqf"]]], "1", "1"],
		["Build Box", [3], "", -5, [["expression", format[_EXECscript6, "Box.sqf"]]], "1", "1"],
		["Weapon Box", [4], "", -5, [["expression", format[_EXECscript6, "WeaponBox.sqf"]]], "1", "1"],
		["Health Box", [5], "", -5, [["expression", format[_EXECscript6, "HealthBox.sqf"]]], "1", "1"],
		["Delete Item", [6],  "", -5, [["expression", format[_EXECscript6,"delete.sqf"]]], "1", "1"],
		["Key Spawn", [7],  "", -5, [["expression", format[_EXECscript6,"KeySpawn.sqf"]]], "1", "1"],
		["", [-1], "", -5, [["expression", ""]], "1", "0"],
			["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
